...
void enableCurrentSnsTimer(
    uint8_t tNum);            // enable timer interrupt for current reading
void setFastAnalogRead(void); // change the ADC clock prescaler to DIV (to
                              // reduce time in curr sense interrupt)
