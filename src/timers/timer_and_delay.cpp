...
bool NB_DELAY_CLASS::started(void) { return _started; }
...
long NB_DELAY_CLASS::getInterval(void) { return _interval; }

// function used to increment the timer after a particular period (us, ms,
// seconds etc)
unsigned long MS_NB_DELAY::ticker(void) { return millis(); }

// function used to increment the timer after a particular period (us, ms,
// seconds etc)
unsigned long US_NB_DELAY::ticker(void) { return micros(); }
...
bool NB_TIMER_CLASS::started(void) { return _started; }
...
bool NB_TIMER_CLASS::paused() { return _paused; }
...
// function used to increment the timer after a particular period (us, ms,
// seconds etc)
unsigned long MS_NB_TIMER::ticker(void) { return millis(); }

// function used to increment the timer after a particular period (us, ms,
// seconds etc)
unsigned long US_NB_TIMER::ticker(void) { return micros(); }